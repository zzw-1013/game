...
public class ThirdActivity extends AppCompatActivity {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.drawable.img_lunchuan_00x00,R.drawable.img_lunchuan_00x01,R.drawable.img_lunchuan_00x02,
            R.drawable.img_lunchuan_01x00,R.drawable.img_lunchuan_01x01,R.drawable.img_lunchuan_01x02,
            R.drawable.img_lunchuan_02x00,R.drawable.img_lunchuan_02x01,R.drawable.img_lunchuan_02x02};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pre.setImageResource(R.drawable.lunchuan);
//        打乱碎片的函数
        disruptRandom();
//        handler.sendEmptyMessageDelayed(1,1000);
    }
