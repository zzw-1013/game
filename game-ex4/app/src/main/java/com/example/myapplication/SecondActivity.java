...
public class SecondActivity extends AppCompatActivity {
    ...
    int time = 0;
    //    存放碎片的数组，便于进行统一的管理
    private int[]image = {R.drawable.img_lianai_00x00,R.drawable.img_lianai_00x01,R.drawable.img_lianai_00x02,
            R.drawable.img_lianai_01x00,R.drawable.img_lianai_01x01,R.drawable.img_lianai_01x02,
            R.drawable.img_lianai_02x00,R.drawable.img_lianai_02x01,R.drawable.img_lianai_02x02};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pre.setImageResource(R.drawable.lianai);
//        打乱碎片的函数
        disruptRandom();
//        handler.sendEmptyMessageDelayed(1,1000);
    }
